<template>
<div class="product-list mt-0" id="product-list">
    <p v-if="loading">Loading...</p>
    <div class="container" v-else>
        <p class="text-suggest">Sản phẩm tương tự</p>
            ...
            <div v-for="product in products" :key="product.id" class="col-md-3 mt-3">
                ...
                <div class="card product-item">
                    ...
                    <router-link to="/compare">
                        <button type="button" class="btn btn-sm btn-addcart">So sánh chi tiết</button>
                    </router-link>
                </div>
                <!-- PRODUCT NOT SALE -->
